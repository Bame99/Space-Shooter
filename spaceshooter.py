...
class Star(pygame.sprite.Sprite):
    def __init__(self, groups, surf):
        ...
        self.rect = self.image.get_rect(center = (randint(0,WINDOW_WIDTH), (randint(0,WINDOW_HEIGHT)))) or 1 in range (20)
...
def display_score():
    ...
    pygame.draw.rect(display_surface, (255,255,.255), text_rect.inflate(20,30).move(0,-10), 5, 10)


# General Setup
pygame.init()
WINDOW_WIDTH, WINDOW_HEIGHT = 1400, 920
...
explosion_frames = [pygame.image.load(join('images', 'explosion.png')).convert_alpha()]

# Audio imports
laser_sound = pygame.mixer.Sound(join('audio', 'laser.mp3'))
laser_sound.set_volume(0.5)
explosion_sound = pygame.mixer.Sound(join('audio', 'explosion.mp3'))
explosion_sound.set.volume(0.5)
damage_sound = pygame.mixer.Sound(join('audio', 'damage.mp3'))
